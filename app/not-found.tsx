...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-navy flex items-center justify-center relative overflow-hidden">
      ...
      {/* Decorative circles */}
      <div className="absolute top-1/4 left-1/4 w-64 h-64 rounded-full border border-gold/[0.05] animate-pulse" />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full border border-gold/[0.03] animate-pulse" style={{ animationDelay: '1s' }} />
      ...
      <div className="relative z-10 text-center px-6">
        ...
        >
          ...
          <div className="relative mb-8">
            <span 
              className="text-[180px] sm:text-[250px] font-bold text-gold/10 select-none"
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <svg 
                className="w-24 h-24 sm:w-32 sm:h-32 text-gold animate-float" 
                viewBox="0 0 100 100" 
                fill="none"
              >
                ...
                <path d="M30 40 Q50 20 70 40" stroke="currentColor" strokeWidth="2" strokeLinecap="round" fill="none"/>
                <circle cx="35" cy="45" r="5" fill="currentColor"/>
                <circle cx="65" cy="45" r="5" fill="currentColor"/>
                <path d="M35 65 Q50 55 65 65" stroke="currentColor" strokeWidth="2" strokeLinecap="round" fill="none"/>
              </svg>
            </div>
          </div>
          ...
          <motion.h1 
            ...
            className="font-[family-name:var(--font-heading)] text-3xl sm:text-4xl text-gold mb-4"
          >
          ...
          >
            ربما تم نقل هذه الصفحة أو حذفها. دعنا نأخذك إلى الصفحة الرئيسية
          </motion.p>
